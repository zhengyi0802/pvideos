...
<form action="{{ route('actresses.store') }}" method="POST">
     @csrf
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="radio" name="amatuer" value="1" checked>{{ __('actresses.amatuer') }}
                <input type="radio" name="amatuer" value="0">{{ __('actresses.job') }}
            </div>
        </div>
